<template>
  ...
  >
      ...
      <ul class="nav navbar-nav flex-row">
        ...
        <li class="nav-item nav-toggle">
          <a class="nav-link modern-nav-toggle pr-0" data-toggle="collapse"
            ...
            ><i
              class="toggle-icon bx font-medium-4 d-none d-xl-block primary"
              data-ticon="bx-disc"
            ></i
          ></a>
        </li>
    ...
    <div class="main-menu-content">
      ...
      >
        <li class="nav-item">
          <a href="../../../html/ltr/vertical-menu-boxicons-template/index.html"
        ...
        <li class="nav-item">
          <a href="#"
            ...
            ><span class="menu-title text-truncate" data-i18n="Starter kit"
              >Starter kit</span
            ></a
          >
        ...
        <template v-if="listRolPermiso.includes('index.permiso')">
          <li class="nav-item">
            <router-link :to="'/permiso'"
              ...
              ><span class="menu-title text-truncate" data-i18n="Rol"
                >Permisos</span
              ></router-link
            >
          </li>
        ...
        <template v-if="listRolPermiso.includes('index.usuario')">
          <li class="nav-item">
            <router-link :to="'/usuario'"
              ><i class="bx bx-folder"></i
              ><span class="menu-title text-truncate" data-i18n="usuarios"
                >Usuarios</span
              ></router-link
            >
          </li>
