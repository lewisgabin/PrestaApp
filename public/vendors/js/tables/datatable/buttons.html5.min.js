...
(function(n) {
  ...
  D.ext.buttons.copyHtml5 = {
    className: "buttons-copy buttons-html5 bx bxs-copy-alt btn-icon btn-light-warning rounded-circle ",
  ...
  D.ext.buttons.excelHtml5 = {
    className: "buttons-excel btn-light-success buttons-html5 bx bxs-file-doc btn-icon rounded-circle",
  ...
  D.ext.buttons.pdfHtml5 = {
    className: "buttons-pdf buttons-html5 bx bxs-file-pdf btn-icon rounded-circle btn-light-danger rounded-circle",
    available: function() {
